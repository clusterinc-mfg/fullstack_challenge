...
/* harmony import */ var _apollo_react_ssr__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @apollo/react-ssr */ "@apollo/react-ssr");
...
/* harmony import */ var _services_apollo_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../services/apollo.service */ "./services/apollo.service.ts");
...
/* harmony default export */ __webpack_exports__["default"] = (App => {
  ...
  return _temp = _class = class Apollo extends react__WEBPACK_IMPORTED_MODULE_10___default.a.Component {
    static async getInitialProps(ctx) {
      const {
        AppTree
      } = ctx;
      const apollo = Object(_services_apollo_service__WEBPACK_IMPORTED_MODULE_11__["default"])();
      ...
      if (true) {
        try {
          ...
          await Object(_apollo_react_ssr__WEBPACK_IMPORTED_MODULE_8__["getDataFromTree"])(__jsx(AppTree, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_6__["default"])({}, appProps, {
            apolloClient: apollo,
            __source: {
    ...
    constructor(props) {
      super(props);
      this.apolloClient = Object(_services_apollo_service__WEBPACK_IMPORTED_MODULE_11__["default"])(props.apolloState);
    }

    render() {
      return __jsx(App, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_6__["default"])({
  ...
  }, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(_class, "displayName", 'withApollo(App)'), _temp;
});
...
/* harmony import */ var _hocs_withApolloClient__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../hocs/withApolloClient */ "./hocs/withApolloClient.tsx");
/* harmony import */ var _redux_configureStore__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../redux/configureStore */ "./redux/configureStore.ts");
/* harmony import */ var _theme_themes_base__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../theme/themes/base */ "./theme/themes/base.ts");
/* harmony import */ var _theme_themes_muiTheme__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../theme/themes/muiTheme */ "./theme/themes/muiTheme.ts");

var _jsxFileName = "/Users/bradtudor/Documents/interview_challenges/Frontend Challenge/frontend-challenge/src/pages/_app.tsx";
...
class App extends next_app__WEBPACK_IMPORTED_MODULE_3___default.a {
  ...
  render() {
    ...
    return __jsx(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_1__["ApolloProvider"], {
      ...
      theme: _theme_themes_muiTheme__WEBPACK_IMPORTED_MODULE_10__["default"],
      __source: {
        fileName: _jsxFileName,
        lineNumber: 37
      },
      ...
      theme: _theme_themes_base__WEBPACK_IMPORTED_MODULE_9__["theme"],
      __source: {
        fileName: _jsxFileName,
        lineNumber: 38
      },
      ...
      __self: this
    }, __jsx(_theme_themes_base__WEBPACK_IMPORTED_MODULE_9__["GlobalStyle"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 40
      },
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_hocs_withApolloClient__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_redux_configureStore__WEBPACK_IMPORTED_MODULE_8__["default"])(App)));
...
/***/ "./redux/Filter/filter.reducer.ts":
/*!****************************************!*\
  !*** ./redux/Filter/filter.reducer.ts ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _filter_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filter.actions */ "./redux/Filter/filter.actions.ts");
...
/* harmony default export */ __webpack_exports__["default"] = ((state = initialState, action) => {
  switch (action.type) {
    case _filter_actions__WEBPACK_IMPORTED_MODULE_0__["FilterActionTypes"].updateFilter:
      {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _term_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./term.actions */ "./redux/Term/term.actions.ts");
...
/* harmony default export */ __webpack_exports__["default"] = ((state = initialState, action) => {
  switch (action.type) {
    case _term_actions__WEBPACK_IMPORTED_MODULE_0__["TermActionTypes"].updateTerm:
      {
        return action.payload;
      }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var next_redux_saga__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next-redux-saga */ "next-redux-saga");
/* harmony import */ var next_redux_saga__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(next_redux_saga__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _rootReducer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./rootReducer */ "./redux/rootReducer.ts");
/* harmony import */ var _rootSaga__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./rootSaga */ "./redux/rootSaga.ts");
...
const configureStore = (initialState = {}, {
  ...
  const reducer = isServer ? _rootReducer__WEBPACK_IMPORTED_MODULE_7__["default"] : Object(redux_persist__WEBPACK_IMPORTED_MODULE_4__["persistReducer"])(persistConfig, _rootReducer__WEBPACK_IMPORTED_MODULE_7__["default"]);
  const store = Object(redux__WEBPACK_IMPORTED_MODULE_2__["createStore"])(reducer, initialState, Object(redux__WEBPACK_IMPORTED_MODULE_2__["applyMiddleware"])(...middlewares));
  store.sagaTask = sagaMiddleware.run(_rootSaga__WEBPACK_IMPORTED_MODULE_8__["default"]);
...
/* harmony default export */ __webpack_exports__["default"] = (BaseComponent => next_redux_wrapper__WEBPACK_IMPORTED_MODULE_1___default()(configureStore)(next_redux_saga__WEBPACK_IMPORTED_MODULE_0___default()(BaseComponent)));
...
/* harmony import */ var _Term_term_reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Term/term.reducer */ "./redux/Term/term.reducer.ts");
/* harmony import */ var _Filter_filter_reducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Filter/filter.reducer */ "./redux/Filter/filter.reducer.ts");



/* harmony default export */ __webpack_exports__["default"] = (Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  term: _Term_term_reducer__WEBPACK_IMPORTED_MODULE_1__["default"],
  filter: _Filter_filter_reducer__WEBPACK_IMPORTED_MODULE_2__["default"]
}));
...
const create = initialState => {
  ...
  const fetchClient = !isBrowser && isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_10___default.a;
  const httpLink = Object(apollo_link_http__WEBPACK_IMPORTED_MODULE_9__["createHttpLink"])({
  ...
  return new apollo_boost__WEBPACK_IMPORTED_MODULE_7__["ApolloClient"]({
...
/* harmony import */ var _muiTheme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./muiTheme */ "./theme/themes/muiTheme.ts");
/* harmony import */ var _patterns_breakpoints__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../patterns/breakpoints */ "./theme/patterns/breakpoints.ts");
/* harmony import */ var _patterns_colors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../patterns/colors */ "./theme/patterns/colors.ts");
/* harmony import */ var _patterns_fonts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../patterns/fonts */ "./theme/patterns/fonts.ts");
...
const theme = {
  // patterns
  muiTheme: _muiTheme__WEBPACK_IMPORTED_MODULE_2__["default"],
  breakpoints: _patterns_breakpoints__WEBPACK_IMPORTED_MODULE_3__["default"],
  colors: _patterns_colors__WEBPACK_IMPORTED_MODULE_4__["default"],
  fonts: _patterns_fonts__WEBPACK_IMPORTED_MODULE_5__["default"] // components

};

/***/ }),

/***/ "./theme/themes/muiTheme.ts":
/*!**********************************!*\
  !*** ./theme/themes/muiTheme.ts ***!
  \**********************************/
/*! exports provided: default */
