...
/* harmony import */ var _theme_themes_muiTheme__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../theme/themes/muiTheme */ "./theme/themes/muiTheme.ts");
...
var _jsxFileName = "/Users/bradtudor/Documents/interview_challenges/Frontend Challenge/frontend-challenge/src/pages/_document.tsx";
...
class Document extends next_document__WEBPACK_IMPORTED_MODULE_9___default.a {
  static async getInitialProps(ctx) {
    const styledComponentsSheet = new styled_components__WEBPACK_IMPORTED_MODULE_11__["ServerStyleSheet"]();
    const muiSheet = new _material_ui_styles__WEBPACK_IMPORTED_MODULE_8__["ServerStyleSheets"]();
    const originalRenderPage = ctx.renderPage;

    try {
      ctx.renderPage = () => originalRenderPage({
        enhanceApp: App => props => {
          const StyledApp = styledComponentsSheet.collectStyles(__jsx(App, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_7__["default"])({}, props, {
            __source: {
      ...
      return _objectSpread({}, initialProps, {
        styles: __jsx(react__WEBPACK_IMPORTED_MODULE_10___default.a.Fragment, null, initialProps.styles, styledComponentsSheet.getStyleElement(), muiSheet.getStyleElement())
      });
    } finally {
  ...
  render() {
    return __jsx("html", {
      ...
      name: "theme-color",
      content: _theme_themes_muiTheme__WEBPACK_IMPORTED_MODULE_12__["default"].palette.primary.main,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 54
      },
